...
public class GameManager : MonoBehaviour
{
    ...
    [Tooltip("Whether the winning is not dependent upon defeating a specific number of enemies \nDefault: false")]
    public bool notCountingEnemies = false;
    ...
    /// <summary>
    /// Description:
    /// Triggers the winning of the game
    /// Input:
    /// none
    /// Return:
    /// void (no returned value)
